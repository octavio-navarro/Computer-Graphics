...
function main()
{
    ...
    // Drawing rectangles
    drawRect(ctx, 'rgba(0, 0, 200, 0.8)', 120, 10, 100, 100)
    drawRect(ctx, 'rgba(150, 0, 200, 1.0)', 195, 85, 150, 150)

    ctx.fillStyle = 'rgba(0, 0, 0, 1.0)';
    ctx.strokeStyle = 'rgba(255, 0, 0, 1.0)'
    ctx.fillRect(25, 150, 100, 100);
    ctx.clearRect(45, 175, 60, 60);
    ...
    ctx.moveTo(10, 50); // Moves the pen to the coordinates specified by x and y.
    ctx.lineTo(100, 75);
    ctx.lineTo(100, 25);
    ctx.lineTo(10, 50);
    ctx.fill();
    ...
    ctx.arc(250, 300, 50, 0, Math.PI, true); // Outer circle
    ctx.fill();

    drawFace(ctx, 350, 300);
}
